    ...
    <div className="tf-root">
      ...
      <nav>
        <div className="tf-nav">
          <Link href="/" aria-label="Elite Route">
            <BrandMark size={17} />
          </Link>
          <div className="tf-nav-right">
            <Link href="/b2b" className="tf-nav-link">{t.corporate}</Link>
            <Link className="tf-nav-cta" href="/#quote">{t.quoteNow}</Link>
      ...
      <main className="tf-main">
        ...
        <div className="tf-cta">
          ...
          <Link className="tf-cta-btn" href="/#quote">{t.ctaBtn}</Link>
        </div>
      </main>
