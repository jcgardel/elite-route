    ...
    <>
      ...
      <div className="cq">
        <nav className="cq-nav">
          <Link href={home} className="cq-logo">ELITE ROUTE</Link>
          <div className="cq-nav-right">
            <div className="cq-nav-links">
              <Link href={home} className="cq-nl">{t.navServices}</Link>
              <Link href={path(lang, "rates")} className="cq-nl">{t.navRates}</Link>
              <Link href={path(lang, "corporate")} className="cq-nl">{t.navCorporate}</Link>
              <Link href={path(lang, "quote")} className="cq-nl cq-nl-active">{t.navQuote}</Link>
            </div>
            <LangToggle lang={lang} page="quote" />
          </div>
        </nav>
        ...
        <div className="cq-body">
          {sent ? (
            <div className="cq-sent">
              ...
              <br />
              <Link href={path(lang, "corporate")} className="cq-back">{t.backAccount}</Link>
            </div>
          ) : (
            <>
              {/* EMPRESA */}
        ...
        <footer style={{ borderTop:"1px solid #1e1e1e", padding:"20px 56px", display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:8 }}>
          ...
          <Link href={path(lang, "corporate")} style={{ fontSize:11, color:"#C8A46B", textDecoration:"none", letterSpacing:"0.06em" }}>{t.backAccount}</Link>
        </footer>
      </div>
    </>
  );
