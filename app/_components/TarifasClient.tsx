...
const TX = {
  es: {
    ...
    faqs: [
      ...
      ["¿Qué pasa si no llego a la hora acordada?", "En el aeropuerto tienes 60 minutos desde la hora real de aterrizaje; en cualquier otro punto, 30 minutos desde la hora acordada. Dentro de ese plazo intentamos localizarte por teléfono, WhatsApp y correo. Si no hay respuesta, el servicio se marca como no presentado, se cobra al 100% y el chofer se retira."],
  ...
  en: {
    ...
    faqs: [
      ...
      ["What if I am not there at the agreed time?", "At the airport you have 60 minutes from the actual landing time; anywhere else, 30 minutes from the agreed time. Within that window we try to reach you by phone, WhatsApp and email. If there is no reply, the service is recorded as a no-show, charged in full, and the chauffeur leaves."],
